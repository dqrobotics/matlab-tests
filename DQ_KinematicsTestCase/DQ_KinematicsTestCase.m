% CLASS DQ_KinematicsTestCase performs unit tests of the DQ_Kinematics class. 
%
% How to run the unit tests:
%         >> runtests("DQKinematicsTestCase")
%
%
% DQ_KinematicsTestCase Properties:
...
%         whole_body_robot
%
% DQ_KinematicsTestCase Methods:
%             DQKinematicsTestCase() - Constructor
%
% DQ_KinematicsTestCase Methods (Test):
...
classdef DQ_KinematicsTestCase < matlab.unittest.TestCase
    ...
    methods
        function testCase = DQ_KinematicsTestCase()
